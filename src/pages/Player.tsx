        ...
        <div className="h-screen bg-zinc-950 text-zinc-50 flex justify-center items-center">
            <div className="flex w-[1100px] flex-col gap-6">
                <div className="flex items-center justify-between">
                    ...
                    <h1 className="text-2xl font-bold">Fundamentos do Ridux</h1>
            ...
            <main className='relative flex overflow-hidden rounded-lg border border-zinc-800 bg-zinc-900 shadow pr-80'>
                ...
                <ReactPlayer 
                    ...
                    height="100%"
                    controls
                    url="https://www.youtube.com/watch?v=a7eCbdYD6vk"
                />
                </div> 
            </div>
                <aside className='w-80 absolute top-0 botton-0 right-0 border-l divide-y-2 divide-zinc-900 border-zinc-800 bg-zinc-900 overflow-y-scroll scrollbar scrollbar-thin scrollbar-track-zinc-950 scrollbala-thumb-800'>
                    <div>
